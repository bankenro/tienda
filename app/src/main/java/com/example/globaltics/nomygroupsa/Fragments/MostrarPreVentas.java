 ...
 */
public class MostrarPreVentas extends Fragment implements SwipeRefreshLayout.OnRefreshListener {


    public MostrarPreVentas() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mostrar_pre_ventas, container, false);
    ...
    private void descargar() {
        ...
        new RecibirPreVentas(getActivity(),urla,accion,srl,rv,user).execute();
    }
}
