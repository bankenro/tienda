...
import com.example.globaltics.nomygroupsa.Views.Compras.RecibirCompras;
 ...
 */
public class MostrarPostCompras extends Fragment implements SwipeRefreshLayout.OnRefreshListener{


    public MostrarPostCompras() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mostrar_post_compras, container, false);
    ...
    private void descargar() {
        ...
        new RecibirCompras(getActivity(), urla, accion, srl, rv, user).execute();
    }
}
