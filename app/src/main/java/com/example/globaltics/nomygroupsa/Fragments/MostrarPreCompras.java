...
import com.example.globaltics.nomygroupsa.Views.PreCompras.RecibirPreCompras;
import com.example.globaltics.nomygroupsa.Views.PreVentas.RecibirPreVentas;
 ...
 */
public class MostrarPreCompras extends Fragment implements SwipeRefreshLayout.OnRefreshListener {


    public MostrarPreCompras() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mostrar_pre_compras, container, false);
    ...
    private void descargar() {
        ...
        new RecibirPreCompras(getActivity(),urla,accion,srl,rv,user).execute();
    }
