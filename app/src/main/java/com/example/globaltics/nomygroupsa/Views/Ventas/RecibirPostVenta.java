...
public class RecibirPostVenta extends AsyncTask<Void,Void,String> {
    private Context c;
    private String urla,accion,user;
    private SwipeRefreshLayout srl;
    private RecyclerView rv;
    public RecibirPostVenta(Context c, String urla, String accion, SwipeRefreshLayout srl, RecyclerView rv,String user) {
        this.c=c;
        this.urla = urla;
        this.accion = accion;
        this.srl = srl;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s==null){
            ...
            new AnalizarPostVenta(c,rv,srl,s).execute();
        }
    }
    ...
    private String descargar() {
        ...
        try {
            ...
            bw.write(new EmpaquePostVenta(accion,user).packgeData());
            bw.flush();
            bw.close();
            os.close();
